  ...
  <head>
    ...
    <script>
      function check() {
        ...
        answer = $("input[name='volunteer-type']:checked").val();
        switch(answer) {
          case "yes": $("#not-main").hide();break;
          case "no" : $("#not-main").show();break;
          default: 
            // Hide everything bellow
        }

        answer = $("input[name='is-main-contact']:checked").val();
        switch(answer) {
          case "yes": $("#not-main").hide();break;
          case "no" : $("#not-main").show();break;
          default: 
