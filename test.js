...
$(document).ready(function() {
  ...
  //   ""  // Answer
  // );
  addFaq("<p>Why are dogs blue</p>", "<p>Because they like the sky.</p>");addFaq("<p>Why do dogs fly</p>", "<p>Due to the uppies
Multi lines</p>");addFaq("<p>Dogs bark?
Nah, or mayb</p>", "<p>Only at the mole people.</p>");      });
